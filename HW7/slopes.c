...
void calK(double t, double r, double v, double h, double *k1, double *k2, double *k3, double *k4)
{
	...
	k2[0] = functionR(t+h/2,r+k1[0]*h/2,v+k1[1]*h/2);
	k2[1] = functionV(t+h/2,r+k1[0]*h/2,v+k1[1]*h/2);
	
	k3[0] = functionR(t+h/2,r+k2[0]*h/2,v+k2[1]*h/2);
	k3[1] = functionV(t+h/2,r+k2[0]*h/2,v+k2[1]*h/2);
	
	k4[0] = functionR(t+h/2,r+k3[0]*h,v+k3[1]*h);
	k4[1] = functionV(t+h/2,r+k3[0]*h,v+k3[1]*h);
}
